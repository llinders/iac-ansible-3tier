...
def deploy_new_test_environment(customer_number):
...
def deploy_new_prod_environment(customer_number):
    # check if environment already exists
    return

def modify_prod_environment(customer_number):
    return

def delete_test_environment(customer_number):
    return

def delete_prod_enviroment(customer_number):
    return
